          ...
          <div className="max-w-7xl mx-auto space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div className="space-y-1">
                <p className="text-xs text-primary-700 font-semibold uppercase tracking-[0.12em]">Admin snapshot</p>
                <h1 className="text-3xl font-bold text-gray-900">Keep ops in motion</h1>
                <p className="text-gray-600">Quick-read cards, lighter copy, instant status.</p>
              </div>
              ...
              <div className="card-surface rounded-2xl p-6 lg:col-span-2">
                <div className="flex items-center justify-between mb-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Fast skim queue</p>
                  </div>
                  <span className="pill bg-slate-100 border-slate-200">Newest first</span>
                </div>
                <div className="space-y-3">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-white transition">
                      <div>
