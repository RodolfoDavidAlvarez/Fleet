      ...
      <div className="max-w-lg w-full mx-auto p-8">
        <div className="bg-white rounded-2xl shadow-lg p-8 text-center space-y-6 border border-gray-200">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold text-gray-900">Repairs Error</h1>
            <p className="text-gray-600">
              Unable to load repair requests. Please try again.
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href="/dashboard"
              className="px-6 py-3 rounded-lg border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 inline-flex items-center justify-center font-semibold"
            >
              Back to Dashboard
            </Link>
          </div>
