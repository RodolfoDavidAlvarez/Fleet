        ...
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          {itemsPerPage < totalItems && (
            <button
              ...
              className="ml-2 px-3 py-1 text-sm font-medium text-primary-600 hover:text-primary-700 border border-primary-300 rounded-md hover:bg-primary-50 transition-colors"
            >
              See All
            </button>
          )}
            ...
            return (
              <button
                ...
                className={`min-w-[36px] px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                  currentPage === pageNum ? "bg-primary-600 text-white shadow-sm" : "border border-gray-300 text-gray-700 hover:bg-gray-50"
                }`}
              >
                {pageNum}
              </button>
