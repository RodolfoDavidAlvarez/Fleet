...
if ! command -v vercel &> /dev/null; then
    ...
    echo "   2. Select project: agave-fleet (or fleet-management-system)"
...
echo "   Project Settings: https://vercel.com/dashboard/[your-team]/agave-fleet/settings/environment-variables"
echo ""
...
echo "   [ ] NEXTAUTH_URL = https://agavefleet.com"
echo "   [ ] NEXT_PUBLIC_APP_URL = https://agavefleet.com"
